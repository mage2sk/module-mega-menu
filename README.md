<!-- SEO Meta -->
<!--
  Title: Panth Mega Menu for Magento 2 | Multi-Level Dropdown Navigation | Panth Infotech
  Description: Advanced mega menu for Magento 2 with drag-and-drop builder, multi-level dropdowns, category/CMS/custom links, Alpine.js for Hyva, vanilla JS for Luma, mobile responsive drawer, dynamic styles, and per-store-view configuration. Compatible with Magento 2.4.4 - 2.4.8 and PHP 8.1 - 8.4.
  Keywords: magento 2 mega menu, multi-level menu, mega navigation, hyva mega menu, alpine.js menu, dropdown menu, magento navigation, mobile mega menu, drag and drop menu builder, category menu magento
  Author: Kishan Savaliya (Panth Infotech)
  Canonical: https://github.com/mage2sk/module-mega-menu
-->

# Mega Menu for Magento 2 | Multi-Level Dropdown Navigation by Panth Infotech

[![Visitors](https://visitor-badge.laobi.icu/badge?page_id=mage2sk.module-mega-menu&left_color=gray&right_color=0d9488&left_text=Visitors)](https://github.com/mage2sk/module-mega-menu)
...
[![Luma Compatible](https://img.shields.io/badge/Luma-Compatible-brightgreen)](https://magento.com)
...
- [Why Panth Mega Menu](#why-panth-mega-menu)
...
1. Download the extension ZIP from [Packagist](https://packagist.org/packages/mage2kishan/module-mega-menu) or the [Adobe Commerce Marketplace](https://commercemarketplace.adobe.com)
...
- **Hyva theme active** → `view/frontend/templates/menu.hyva.phtml` (Alpine.js + Tailwind)
- **Luma theme active** → `view/frontend/templates/menu.luma.phtml` (vanilla JS)
...
Yes. The full source is on GitHub at [github.com/mage2sk/module-mega-menu](https://github.com/mage2sk/module-mega-menu).
...
- **Packagist:** [packagist.org/packages/mage2kishan/module-mega-menu](https://packagist.org/packages/mage2kishan/module-mega-menu)
- **GitHub:** [github.com/mage2sk/module-mega-menu](https://github.com/mage2sk/module-mega-menu)
...
<p align="center">
  <strong>Ready to upgrade your Magento 2 navigation?</strong><br/>
  <a href="https://kishansavaliya.com/get-quote">
